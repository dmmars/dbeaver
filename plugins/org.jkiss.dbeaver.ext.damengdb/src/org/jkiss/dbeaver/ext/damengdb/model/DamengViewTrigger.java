 ...
 * DamengTableTrigger
 */
public class DamengViewTrigger extends DamengTrigger<DamengTableBase> {
	
    private static final Log log = Log.getLog(DamengViewTrigger.class);

    private DamengSchema ownerSchema;

    private List<DamengTriggerColumn> columns;

    public DamengViewTrigger(DamengTableBase table, String name) {
        super(table, name);
        ownerSchema = table.getSchema();
    }

    public DamengViewTrigger(DamengTableBase table, ResultSet dbResult) {
    ...
    public DamengTableBase getView() {
        return parent;
    }
