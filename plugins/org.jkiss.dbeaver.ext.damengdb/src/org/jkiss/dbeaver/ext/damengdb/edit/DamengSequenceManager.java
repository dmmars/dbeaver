...
public class DamengSequenceManager extends SQLObjectEditor<DamengSequence, DamengSchema> {
    ...
    @Override
    protected DamengSequence createDatabaseObject(DBRProgressMonitor monitor, DBECommandContext context,
                                                  final Object container, Object copyFrom, Map<String, Object> options) {
        DamengSchema schema = (DamengSchema) container;
        return new DamengSequence(schema, "NEW_SEQUENCE");
    }
    ...
    private String buildComment(DamengSequence sequence) {
