...
public class DamengToolTableGatherStatisticsSettings extends SQLToolExecuteSettings<DBSObject> {
    
	private int samplePercent;

    @Property(viewable = true, editable = true, updatable = true, valueValidator = DmStatisticPercentLimiter.class)
    ...
    public static class DmStatisticPercentLimiter
        implements IPropertyValueValidator<DamengToolTableGatherStatisticsSettings, Object> {

        @Override
        public boolean isValidValue(DamengToolTableGatherStatisticsSettings object, Object value)
