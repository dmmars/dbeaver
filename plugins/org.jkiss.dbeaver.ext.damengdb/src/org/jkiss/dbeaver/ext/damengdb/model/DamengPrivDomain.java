...
public class DamengPrivDomain extends DamengObject<DamengDomain> implements DBAPrivilege {
    ...
    public DamengPrivDomain(DamengDomain domain, JDBCResultSet resultSet) {
        super(domain, JDBCUtils.safeGetString(resultSet, "PRIVILEGE"), true);
        ...
        this.hierarchy = JDBCUtils.safeGetBoolean(resultSet, "HIERARCHY", DamengConstants.RESULT_YES_VALUE);
    }
