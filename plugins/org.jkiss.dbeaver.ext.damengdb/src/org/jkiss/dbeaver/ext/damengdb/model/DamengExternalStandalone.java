 ...
 * GenericProcedure
 */
public class DamengExternalStandalone extends DamengProcedureBase<DamengSchema>
    ...
    public DamengExternalStandalone(DamengSchema schema, ResultSet dbResult) {
        ...
        initObjectType(dbResult);// init object type
    }

    public DamengExternalStandalone(DamengSchema damengSchema, String name, DBSProcedureType procedureType) {
        super(damengSchema, name, 0l, procedureType);
    ...
    @Override
    public @Nullable DBSObject refreshObject(@NotNull DBRProgressMonitor monitor) throws DBException {
        return null;
    }
