 ...
 * DamengPrivRole
 */
public class DamengPrivRole extends DamengPriv implements DBSObjectLazy<DamengDataSource> {
    
	private Object role;

    private boolean defaultRole;

    public DamengPrivRole(DamengGrantee user, ResultSet resultSet) {
    ...
    public Object getRole(DBRProgressMonitor monitor) throws DBException {
        ...
        return DamengUtils.resolveLazyReference(monitor, getDataSource(), getDataSource().roleCache, this, null);
    }
