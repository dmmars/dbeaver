 ...
 * DamengPrivTable
 */
public class DamengPrivTable extends DamengObject<DamengTableBase> implements DBAPrivilege {
    ...
    public DamengPrivTable(DamengTableBase table, ResultSet resultSet) {
