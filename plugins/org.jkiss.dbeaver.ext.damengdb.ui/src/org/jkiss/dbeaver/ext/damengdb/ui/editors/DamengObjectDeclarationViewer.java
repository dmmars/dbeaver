...
/**
 * DamengObjectDeclarationViewer helps to view object declaration, but not
 * change it
 */
@SuppressWarnings("rawtypes")
public class DamengObjectDeclarationViewer extends SQLSourceViewer {
	
    public DamengObjectDeclarationViewer() {
    }
    ...
    protected void contributeEditorCommands(IContributionManager toolBarManager) {
        ...
        if (sourceObject instanceof DamengTableBase || sourceObject instanceof DamengSchema) {
